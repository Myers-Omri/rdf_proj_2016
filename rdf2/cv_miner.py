...
from rdf1.Utils import *
from rdf1.miner import miner
...
class Cv_Miner(miner):
    ...
    def mine_cv_rules(self,quick, TH=0.85):
        ...
        s_dump_name = "../rdf1/" + self.subject + "/" + self.subject + "_top.dump"
        p_dump_name = "../rdf1/" + self.subject + "/" + self.subject + "_prop.dump"
